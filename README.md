...
| iamRole                     | codebuild, configurationRecorder, iamPolicy, eksCluster, ecsService, flowLog, glueJob                                                                                                                                                 |
...
| secretsManager              |                                                                                                                                                                                            |
| securityGroup               | alb, asg, clientVpnEndpoint, codebuild, ecsService, lambda, ec2, elb, rdsCluster, rdsDbInstance, eksCluster, elastiCacheCluster                                                                       |
| ses                         |                                                                                                                                                                                            |
| sns                         | kms, cloudtrail, cloudwatch                                                                                                                                                                            |
| sqs                         |                                                                                                                                                                                            |
| subnet                      | alb, asg, codebuild, ec2, ecsService, efsMountTarget, elastiCacheCluster, elb, lambda, natGateway, networkInterface, routeTable, vpc, eksCluster, emrCluster, flowLog                                                     |
