...
| iamRole                     | appSync, codebuild, configurationRecorder, ec2, ecsTask, ecsTaskDefinition, iamInstanceProfile, iamPolicy, eksCluster, ecsService, flowLog, glueJob, managedAirflow, sageMakerNotebookInstance, systemsManagerInstance guardDutyDetector                                                                                                                                                 |
