...
export default ({service: alb, account, region}): Aws_Alb => {
  ...
  const {
    ...
    attributes: {
      ...
      'routing.http.drop_invalid_header_fields.enabled': dropInvalidHeaderFields,
