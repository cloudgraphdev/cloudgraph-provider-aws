...
export default ({
  ...
  const schemaAttributeList = schemaAttributes?.map(({
  ...
  const userPool  = {
    ...
    status,
    lastModifiedDate: lastModifiedDate? lastModifiedDate.toISOString() : undefined,
    ...
    mfaConfiguration,
    deviceConfigChallengeRequiredOnNewDevice: deviceConfiguration?.ChallengeRequiredOnNewDevice? t.yes : t.no,
    deviceConfigDeviceOnlyRememberedOnUserPrompt: deviceConfiguration?.DeviceOnlyRememberedOnUserPrompt? t.yes : t.no,
    ...
    domain,
    customDomain,
    adminCreateUserConfigAllowAdminCreateUserOnly: adminCreateUserConfig?.AllowAdminCreateUserOnly? t.yes : t.no,
